  ...
  return (
    <main className="bg-gray-50 py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {cartItems.length === 0 ? (
          <div className="mx-auto max-w-2xl text-center bg-white p-8 sm:p-12 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="space-y-4">
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-4 sm:flex-nowrap flex-wrap">
                      ...
                      <p className="font-semibold text-right sm:w-20 w-auto">
            ...
            <div className="lg:col-span-1 bg-white p-6 sm:p-8 rounded-lg shadow-lg lg:sticky lg:top-24">
